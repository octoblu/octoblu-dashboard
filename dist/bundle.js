...
/***/ function(module, exports, __webpack_require__) {
	...
	App = __webpack_require__(199);

	FlowDashboard = __webpack_require__(200);

	GatebluDashboard = __webpack_require__(329);

	FlowDeployment = __webpack_require__(338);

	FlowDeploymentAggs = __webpack_require__(342);

	GatebluDeviceInstalls = __webpack_require__(345);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App, Link, React, Route, RouteHandler, Router;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AvgElapsedTimeGauge, FlowDashboard, FlowDeployAvgElapsedTime, FlowDeployAvgElapsedTimeOverTime, FlowDeployOverTime, FlowDeployStatus, OverTimeGauge, React, StatusGauge;

	React = __webpack_require__(1);

	FlowDeployStatus = __webpack_require__(201);

	FlowDeployAvgElapsedTime = __webpack_require__(310);

	FlowDeployAvgElapsedTimeOverTime = __webpack_require__(312);

	FlowDeployOverTime = __webpack_require__(314);

	StatusGauge = __webpack_require__(316);

	AvgElapsedTimeGauge = __webpack_require__(317);

	OverTimeGauge = __webpack_require__(318);
	...
	FlowDashboard = React.createClass({
	  ...
	  componentWillReceiveProps: function(nextProps) {
	    var byUnit, inLast, ref;
	    ref = nextProps.query, inLast = ref.inLast, byUnit = ref.byUnit;
	    this.flowDeployStatus.set({
	      inLast: inLast,
	      byUnit: byUnit
	    });
	    this.flowDeployStatus.fetch();
	    this.flowDeployOverTime.set({
	      inLast: inLast,
	      byUnit: byUnit
	    });
	    this.flowDeployOverTime.fetch();
	    this.flowDeployAvgElapsedTime.set({
	      inLast: inLast,
	      byUnit: byUnit
	    });
	    this.flowDeployAvgElapsedTime.fetch();
	    this.flowDeployAvgElapsedTimeOverTime.set({
	      inLast: inLast,
	      byUnit: byUnit
	    });
	    return this.flowDeployAvgElapsedTimeOverTime.fetch();
	  },
	  componentWillMount: function() {
	    var byUnit, inLast, ref;
	    ref = this.props.query, inLast = ref.inLast, byUnit = ref.byUnit;
	  ...
	  componentDidMount: function() {
	    ...
	    this.flowDeployStatus.fetch();
	    setInterval(this.flowDeployAvgElapsedTime.fetch, 60 * 1000);
	    this.flowDeployAvgElapsedTime.fetch();
	    setInterval(this.flowDeployAvgElapsedTimeOverTime.fetch, 60 * 1000);
	    this.flowDeployAvgElapsedTimeOverTime.fetch();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone, FLOW_DEPLOY_STATUS_QUERY, FlowDeployStatus, _, moment,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	Backbone = __webpack_require__(202);

	_ = __webpack_require__(205);

	moment = __webpack_require__(207);

	FLOW_DEPLOY_STATUS_QUERY = __webpack_require__(309);

	FlowDeployStatus = (function(superClass) {
	  extend(FlowDeployStatus, superClass);

	  function FlowDeployStatus() {
	    this.query = bind(this.query, this);
	    this.fetch = bind(this.fetch, this);
	    this.parse = bind(this.parse, this);
	    this.initialize = bind(this.initialize, this);
	    return FlowDeployStatus.__super__.constructor.apply(this, arguments);
	  }

	  FlowDeployStatus.prototype.defaults = {
	    inLast: '1d'
	  };

	  FlowDeployStatus.prototype.initialize = function(attributes) {
	    var index;
	    if (attributes == null) {
	      attributes = {};
	    }
	    index = attributes.index;
	    return this.url = "http://searchonly:hfpxaq4e7k6gimwcwl@6afa8b1002a9aae2191763621313e6ea.us-west-1.aws.found.io:9200/" + index + "_history/_search";
	  };

	  FlowDeployStatus.prototype.parse = function(response) {
	    var failureRate, failures, flowStart, ref, ref1, ref2, ref3, ref4, ref5, successRate, successes, total;
	    flowStart = _.findWhere(response.aggregations.filter_by_timestamp.group_by_workflow.buckets, {
	      key: 'flow-start'
	    });
	    if (flowStart == null) {
	      flowStart = {};
	    }
	    successes = (ref = (ref1 = _.find((ref2 = flowStart.group_by_success) != null ? ref2.buckets : void 0, {
	      key: 'T'
	    })) != null ? ref1.doc_count : void 0) != null ? ref : 0;
	    failures = (ref3 = (ref4 = _.find((ref5 = flowStart.group_by_success) != null ? ref5.buckets : void 0, {
	      key: 'F'
	  ...
	  FlowDeployStatus.prototype.fetch = function(options) {
	    if (options == null) {
	      options = {};
	    }
	    return FlowDeployStatus.__super__.fetch.call(this, _.defaults({}, options, {
	      type: 'POST',
	  ...
	  FlowDeployStatus.prototype.query = function() {
	    var five_minutes_ago, inLast, query, time, timeUnit, yesterday;
	    inLast = this.get('inLast');
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(203), __webpack_require__(204), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
